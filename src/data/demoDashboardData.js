...
export const demoDashboardData = {
  ...
  kpis: {
    ...
    metrics: [
      ...
      {
        id: "kpi-adoption",
        label: "Adoption equipes",
        value: "78 %",
        subtitle: "6 membres actifs cette semaine",
        trend: 9,
        color: "blue",
      },
      {
        id: "kpi-training",
        label: "Progression formation",
        value: "3 / 5 modules",
        subtitle: "Certification Notion Pro",
        trend: 0,
        color: "purple",
      },
      {
  ...
  resources: {
    items: [
      ...
      {
        id: "resource-video",
        title: "Video - Connecter Notion et Make",
        type: "Video",
        format: "MP4",
  ...
  trainingPreferences: {
    ...
    steps: [
      ...
      {
        id: "step-feedback",
        label: "Feedback et NPS",
        status: "todo",
        description: "Disponible apres le module 3",
      },
    ],
  },
  assistant: {
    ...
    prompts: [
      "Generer un plan d actions pour le CRM ventes",
      "Resume la derniere reunion OKR",
      "Lister les automatisations possibles avec Make",
    ],
    lastUpdates: [
      {
