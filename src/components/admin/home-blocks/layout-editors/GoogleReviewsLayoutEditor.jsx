...
const GoogleReviewsLayoutEditor = ({ value = {}, onChange }) => {
    ...
    <div className="space-y-6">
      <section className="space-y-4">
        <div>
          <Label>Titre</Label>
          <Input
            placeholder="Ils parlent de nous sur Google"
            value={value.title ?? ''}
        ...
        <div>
          ...
          <Textarea
            rows={3}
            placeholder="Des avis authentiques d entrepreneurs et d equipes qui utilisent NotionLab au quotidien."
      ...
      <section className="space-y-4">
        ...
        <div>
          <Label>ID du lieu Google (placeId)</Label>
          <Input
            placeholder="Ex. ChIJN1t_tDeuEmsRUsoyG83frY4"
            value={placeIdValue}
            onChange={handleInput('placeId')}
          />
          <p className="mt-1 text-xs text-muted-foreground">
            Recuperer le placeId via la Google Places API ou l interface Google Maps Platform.
          </p>
        </div>
        <div className="grid gap-4 md:grid-cols-2">
          ...
          <div>
            ...
            <p className="mt-1 text-xs text-muted-foreground">
              Defini le parametre language lors de l appel a Google Places.
            </p>
          </div>
        </div>
      </section>
...
export default GoogleReviewsLayoutEditor;
