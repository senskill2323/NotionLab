    ...
    <Card className="h-full border border-border/60 shadow-sm">
      <CardContent className="p-4 md:p-6 space-y-5">
        ...
        <div className="grid gap-4 lg:grid-cols-[2fr,1fr]">
          <div className="rounded-xl border border-border/60 bg-gradient-to-br from-primary/5 to-primary/10 p-5 lg:p-6 shadow-sm">
          ...
          <div className="rounded-xl border border-border/60 bg-card/90 p-5 shadow-sm flex flex-col gap-3">
        ...
        <div className="grid gap-4 md:grid-cols-3">
          {highlights?.map((item) => (
            <div
              key={item.id}
              className="rounded-lg border border-border/50 bg-muted/30 px-4 py-4 shadow-inner"
            >
        ...
        <div className="grid gap-3 md:grid-cols-2">
          {quickLinks?.map((link) => (
            <button
              ...
              className="flex w-full items-start gap-3 rounded-lg border border-dashed border-border/70 bg-background/90 p-4 text-left transition hover:border-primary/50 hover:bg-primary/5"
            >
