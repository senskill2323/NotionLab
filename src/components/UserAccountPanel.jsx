        ...
        {isOpen && (
          <>
            ...
            <motion.div
              ...
              className="account-menu-panel absolute right-0 top-full z-50 mt-1.5 w-[320px] max-w-sm overflow-hidden rounded-3xl border border-transparent p-[1px] shadow-[0_18px_70px_-38px_rgba(124,58,237,0.85)] backdrop-blur-xl max-sm:fixed max-sm:inset-x-4 max-sm:top-16 max-sm:right-auto max-sm:mt-2.5 max-sm:w-auto"
              role="dialog"
              aria-modal="true"
