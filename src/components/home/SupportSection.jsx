          ...
          <motion.div variants={itemVariants}>
            <div className="mb-4">
              <span className="inline-flex items-center px-4 py-1.5 rounded-full text-sm font-medium bg-primary/10 text-primary border border-primary/30">
                ...
                Votre Bouée de Sauvetage Notion
              </span>
            </div>
            <h2 className="text-4xl md:text-5xl font-extrabold mb-6 leading-tight">
              Ne restez jamais bloqué.
            </h2>
            <p className="text-xl text-gray-300 mb-8">Le vrai "plus" de mon projet, c'est un système qui vous aide! Vous avez une ligne directe avec un expert Notion, et j'espère à la longue, plusieurs passionnés qui me rejoindront. Rejoignez des milliers d'utilisateurs qui ont déjà révolutionné leur organisation avec Notion. Economisez du temps et de l'énergie en recevant au minimum des astuces pour commencer proprement sur Notion.</p>
          </motion.div>

          <motion.div variants={itemVariants} className="relative h-full min-h-[400px]">
            <img alt="Un expert Notion souriant, disponible pour aider via un chat" class="w-full h-full object-cover rounded-3xl shadow-2xl shadow-primary/20" src="https://horizons-cdn.hostinger.com/33d72ce2-b6b0-4274-b8ce-63300e44633e/capture-daa-c-cran-2025-08-24-235707-02xTj.png" />
          </motion.div>
        </motion.div>
      </div>
    </section>;
