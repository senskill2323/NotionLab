import React, { useState, useEffect } from 'react';
    ...
    import { Clock, User, ArrowRight, MapPin, Loader2 } from 'lucide-react';
            ...
            <div className="pt-32 pb-16">
              <div className="container mx-auto px-4">
                ...
                {loading ? <div className="flex justify-center items-center h-64">
                    ...
                    {formations.map((formation, index) => <motion.div key={formation.id} initial={{
                  opacity: 0,
                  y: 30
                }} animate={{
                  opacity: 1,
                  ...
                  delay: index * 0.1
                        ...
                        <Card className="glass-effect hover:border-primary transition-all duration-300 h-full flex flex-col overflow-hidden">
                          {formation.cover_image_url && <div className="h-48 w-full overflow-hidden">
                              <img  alt={`Image de la formation ${formation.title}`} src="https://images.unsplash.com/photo-1561555699-c9e7f2eaa4fa" />
                            </div>}
                          <CardHeader>
                          ...
                          <CardContent className="flex flex-col flex-grow">
                            <div className="flex-grow space-y-4 mb-6">
                              ...
                              <div className="flex items-center gap-2 text-sm text-muted-foreground">
                                ...
                                <span>{formation.duration_text}</span>
                              </div>
                              <div className="flex items-center gap-2 text-sm text-muted-foreground">
